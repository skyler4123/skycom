// sweetalert2@11.26.3 downloaded from https://ga.jspm.io/npm:sweetalert2@11.26.3/dist/sweetalert2.all.js
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */const tt=(e,t)=>{const o=F();if(o){de(o);we(o,Boolean(t.footer),"block");t.footer&&Pe(t.footer,o);ee(o,t,"footer")}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
...
/**
       ...
       */
const a=t=>{e.close({isDismissed:true,dismiss:t,isConfirmed:false,isDenied:false})};Rt.swalPromiseResolve.set(e,n);Rt.swalPromiseReject.set(e,s);t.confirmButton.onclick=()=>{Lo(e)};t.denyButton.onclick=()=>{Po(e)};t.cancelButton.onclick=()=>{So(e,a)};t.closeButton.onclick=()=>{a(jt.close)};mn(o,t,a);zt(i,o,a);fo(e,o);Jn(o);us(i,o,a);ws(t,o);setTimeout((()=>{t.container.scrollTop=0}))}));
/**
