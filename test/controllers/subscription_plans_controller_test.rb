...
class SubscriptionPlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscription_plan" do
    assert_difference("SubscriptionPlan.count") do
      post subscription_plans_url, params: { subscription_plan: { auto_renew: @subscription_plan.auto_renew, business_type: @subscription_plan.business_type, code: @subscription_plan.code, company_group_id: @subscription_plan.company_group_id, company_id: @subscription_plan.company_id, country_code: @subscription_plan.country_code, description: @subscription_plan.description, discarded_at: @subscription_plan.discarded_at, lifecycle_status: @subscription_plan.lifecycle_status, name: @subscription_plan.name, period_id: @subscription_plan.period_id, price_id: @subscription_plan.price_id, workflow_status: @subscription_plan.workflow_status } }
    end
