...
class StatisticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statistic" do
    assert_difference("Statistic.count") do
      post statistics_url, params: { statistic: { data: @statistic.data, owner_id: @statistic.owner_id, owner_type: @statistic.owner_type, recorded_at: @statistic.recorded_at } }
    end
  ...
  test "should update statistic" do
    patch statistic_url(@statistic), params: { statistic: { data: @statistic.data, owner_id: @statistic.owner_id, owner_type: @statistic.owner_type, recorded_at: @statistic.recorded_at } }
