...
ActiveRecord::Schema[8.0].define(version: 2025_11_20_165153) do
  ...
  create_table "order_item_appointments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["appoint_to_type", "appoint_to_id"], name: "index_order_item_appointments_on_appoint_to"
    t.index ["discarded_at"], name: "index_order_item_appointments_on_discarded_at"
    t.index ["order_id"], name: "index_order_item_appointments_on_order_id"
  end
