...
ActiveRecord::Schema[8.0].define(version: 2026_01_05_172509) do
  ...
  create_table "branches", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["company_group_id"], name: "index_branches_on_company_group_id"
    t.index ["discarded_at"], name: "index_branches_on_discarded_at"
    t.index ["parent_company_id"], name: "index_branches_on_parent_company_id"
  end
  ...
  add_foreign_key "branches", "branches", column: "parent_company_id"
  add_foreign_key "branches", "company_groups"
