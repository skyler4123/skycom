class CreateArticleAppointments < ActiveRecord::Migration[8.0]
  def change
    create_table :article_appointments, id: :uuid do |t|
    ...
    add_index :article_appointments, :discarded_at
    add_index :article_appointments, [ :appoint_to_type, :appoint_to_id ]
  end
end
