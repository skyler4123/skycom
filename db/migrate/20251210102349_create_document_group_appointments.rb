class CreateDocumentGroupAppointments < ActiveRecord::Migration[8.0]
  def change
    create_table :document_group_appointments, id: :uuid do |t|
    ...
    add_index :document_group_appointments, :discarded_at
    add_index :document_group_appointments, [:appoint_to_type, :appoint_to_id]
  end
end
