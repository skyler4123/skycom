class CreateNotificationGroupAppointments < ActiveRecord::Migration[8.0]
  def change
    create_table :notification_group_appointments, id: :uuid, default: -> { "uuidv7()" } do |t|
    ...
    add_index :notification_group_appointments, [ :appoint_to_type, :appoint_to_id ]
  end
end
