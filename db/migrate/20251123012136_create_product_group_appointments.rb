class CreateProductGroupAppointments < ActiveRecord::Migration[8.0]
  def change
    create_table :product_group_appointments, id: :uuid, default: -> { "uuidv7()" } do |t|
      t.references :company, null: false, foreign_key: true, type: :uuid
      t.references :product_group, null: false, foreign_key: true, type: :uuid
    ...
    add_index :product_group_appointments, [ :appoint_to_type, :appoint_to_id ]
  end
end
