class CreateTaskAppointments < ActiveRecord::Migration[8.0]
  def change
    create_table :task_appointments, id: :uuid, default: -> { "uuidv7()" } do |t|
    ...
    add_index :task_appointments, [ :appoint_to_type, :appoint_to_id ]
  end
end
