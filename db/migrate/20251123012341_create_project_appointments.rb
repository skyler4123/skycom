class CreateProjectAppointments < ActiveRecord::Migration[8.0]
  def change
    create_table :project_appointments, id: :uuid, default: -> { "uuidv7()" } do |t|
    ...
    add_index :project_appointments, [ :appoint_to_type, :appoint_to_id ]
  end
end
