class CreateEventAppointments < ActiveRecord::Migration[8.0]
  def change
    create_table :event_appointments, id: :uuid do |t|
    ...
    add_index :event_appointments, :discarded_at
    add_index :event_appointments, [:appoint_to_type, :appoint_to_id]
  end
end
