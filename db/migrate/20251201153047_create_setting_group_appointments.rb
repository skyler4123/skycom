class CreateSettingGroupAppointments < ActiveRecord::Migration[8.0]
  def change
    create_table :setting_group_appointments, id: :uuid do |t|
    ...
    add_index :setting_group_appointments, :discarded_at
    add_index :setting_group_appointments, [:appoint_to_type, :appoint_to_id]
  end
end
