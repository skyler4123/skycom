class AttendanceLogsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @attendance_log.save
        format.html { redirect_to @attendance_log, notice: "Attendance log was successfully created." }
  ...
  def update
    respond_to do |format|
      if @attendance_log.update(attendance_log_params)
        format.html { redirect_to @attendance_log, notice: "Attendance log was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to attendance_logs_path, notice: "Attendance log was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_attendance_log
      @attendance_log = AttendanceLog.find(params.expect(:id))
    end
