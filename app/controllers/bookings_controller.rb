class BookingsController < ApplicationController
  ...
  private
    ...
    def booking_params
      params.expect(booking: [ :company_id, :appoint_from_id, :appoint_from_type, :appoint_to_id, :appoint_to_type, :name, :description, :code, :status, :business_type, :discarded_at ])
    end
end
