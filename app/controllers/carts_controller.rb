class CartsController < ApplicationController
  ...
  private
    ...
    def cart_params
      params.expect(cart: [ :branch_id, :cart_group_id, :name, :description, :code, :sku, :barcode, :upc, :ean, :manufacturer_code, :serial_number, :batch_number, :expiration_date, :status, :business_type, :discarded_at ])
    end
end
