          ...
          <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            <div
              ...
              <div class="p-4 flex-1 flex flex-col justify-between">
                <h3 class="font-semibold text-gray-800 dark:text-gray-100 mb-1">Vintage Leather Jacket</h3>
                <p class="text-sm text-indigo-600 font-medium">$120.00</p>
              </div>
            </div>
            <div
              class="flex flex-col bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <div class="p-4 flex-1 flex flex-col justify-between">
                <h3 class="font-semibold text-gray-800 dark:text-gray-100 mb-1">Wireless Headphones</h3>
                <p class="text-sm text-indigo-600 font-medium">$89.99</p>
              </div>
            </div>
            <div
              class="flex flex-col bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <div class="p-4 flex-1 flex flex-col justify-between">
                <h3 class="font-semibold text-gray-800 dark:text-gray-100 mb-1">Modern Art Print</h3>
                <p class="text-sm text-indigo-600 font-medium">$45.50</p>
              </div>
            </div>
            <div
              class="flex flex-col bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <div class="p-4 flex-1 flex flex-col justify-between">
                <h3 class="font-semibold text-gray-800 dark:text-gray-100 mb-1">Classic Canvas Tote</h3>
            ...
            <div
              ...
              <div class="p-4 flex-1 flex flex-col justify-between">
                <h3 class="font-semibold text-gray-800 dark:text-gray-100 mb-1">Suede Ankle Boots</h3>
                <p class="text-sm text-indigo-600 font-medium">$95.00</p>
              </div>
            </div>
            <div
              class="flex flex-col bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <div class="p-4 flex-1 flex flex-col justify-between">
                <h3 class="font-semibold text-gray-800 dark:text-gray-100 mb-1">Striped Cotton Shirt</h3>
                <p class="text-sm text-indigo-600 font-medium">$55.00</p>
              </div>
            </div>
            <div
              class="flex flex-col bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <div class="p-4 flex-1 flex flex-col justify-between">
                <h3 class="font-semibold text-gray-800 dark:text-gray-100 mb-1">Minimalist Watch</h3>
                <p class="text-sm text-indigo-600 font-medium">$150.00</p>
              </div>
            </div>
            <div
              class="flex flex-col bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <div class="p-4 flex-1 flex flex-col justify-between">
                <h3 class="font-semibold text-gray-800 dark:text-gray-100 mb-1">Slim Fit Denim Jeans</h3>
                <p class="text-sm text-indigo-600 font-medium">$78.00</p>
              </div>
            </div>
          </div>
        </div>
