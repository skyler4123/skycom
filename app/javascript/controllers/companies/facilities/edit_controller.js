...
export default class Companies_Facilities_EditController extends Companies_LayoutController {
  ...
  contentHTML() {
    ...
    const fields = `
      <div class="space-y-6">
        <h2 class="text-xl font-bold text-slate-900 dark:text-white">Edit Facility</h2>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="space-y-1">
            <label class="text-xs font-medium text-slate-500 dark:text-gray-400">Branch</label>
