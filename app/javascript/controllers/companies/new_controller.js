...
export default class Company_NewController extends LayoutController {
    ...
    return `
      <main class="w-full h-full flex justify-center items-center">
        <div
          ...
          <!-- Form -->
          <form
            action="${ROUTES.createCompanyPath}"
            data-method="post
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 h-18">
              <div class="flex flex-col gap-2">
                ...
                <input
                  ...
                  id="companyName" name="company[name]" placeholder="e.g. Skyline Boutique" type="text" required />
              </div>
              <div class="flex flex-col gap-2">
                ...
                <input
                  class="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-slate-900 dark:text-slate-100 focus:outline-0 focus:ring-0 border border-slate-300 dark:border-slate-700 bg-white dark:bg-gray-950 focus:border-indigo-600 h-12 px-4 text-base font-normal leading-normal placeholder:text-slate-400"
                  id="phoneNumber" name="company[phone_number]" placeholder="+1 (555) 123-4567" type="tel" required />
              </div>
            </div>
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="relative">
                <select
                  ...
                  id="country" name="company[country]" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="flex flex-col gap-2">
                ...
                <div class="relative">
                  <select
                    class="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-slate-900 dark:text-slate-100 focus:outline-0 focus:ring-0 border border-slate-300 dark:border-slate-700 bg-white dark:bg-gray-950 focus:border-indigo-600 h-12 px-4 text-base font-normal leading-normal appearance-none"
                    id="retailCategory" name="company[business_type]" required>
              ...
              <div class="flex flex-col gap-2">
                ...
                <div class="relative">
                  <select
                    class="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-slate-900 dark:text-slate-100 focus:outline-0 focus:ring-0 border border-slate-300 dark:border-slate-700 bg-white dark:bg-gray-950 focus:border-indigo-600 h-12 px-4 text-base font-normal leading-normal appearance-none"
                    id="timezone" name="company[timezone]" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="flex flex-col gap-2">
                ...
                <div class="relative">
                  <select
                    class="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-slate-900 dark:text-slate-100 focus:outline-0 focus:ring-0 border border-slate-300 dark:border-slate-700 bg-white dark:bg-gray-950 focus:border-indigo-600 h-12 px-4 text-base font-normal leading-normal appearance-none"
                    id="currencyCode" name="company[currency]" required>
              ...
              <div class="flex flex-col gap-2">
                ...
                <input
                  class="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-slate-900 dark:text-slate-100 focus:outline-0 focus:ring-0 border border-slate-300 dark:border-slate-700 bg-white dark:bg-gray-950 focus:border-indigo-600 h-12 px-4 text-base font-normal leading-normal placeholder:text-slate-400"
                  id="taxId" name="company[tax_id]" placeholder="e.g. 12-3456789" type="text" />
              </div>
            ...
            <div class="flex flex-col gap-2">
              ...
              <textarea
                ...
                id="description" name="company[description" placeholder="Describe your store or any specific needs..."></textarea>
            </div>
