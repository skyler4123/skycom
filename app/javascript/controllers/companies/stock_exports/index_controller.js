...
export default class Companies_StockExports_IndexController extends Companies_LayoutController {
  ...
  // Depends on BE: Companies::StockExportsController#index (list + Meilisearch q / filters[key])
  ...
  contentHTML() {
    ...
    const fallbackColumns = [
      ...
      { key: "name", name: translate("Stock Export") },
        ...
        <div class="p-4 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 flex flex-col">
          ...
          <div class="overflow-x-auto">
            ${table({
              ...
              mappingLookup,
              renderers: {
                name: (value) => `<p class="font-medium text-slate-900 dark:text-white">${value || translate("Unnamed Stock Export")}</p>`,
                ...
                business_type: (value) => `<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-300">${Helpers.capitalize((value || 'sale').replace(/_/g, ' '))}</span>`,
