...
export const SIDEBAR_ITEMS = [
  ...
  { key: "warehouses", group: "company", icon: "warehouse", label: "Warehouses", href: (cid) => Helpers.company_warehouses_path(cid) },
  ...
  { key: "facilities", group: "company", icon: "meeting_room", label: "Facilities", href: (cid) => Helpers.company_facilities_path(cid) },
