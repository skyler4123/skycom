...
export default class Companies_Pages_NewController extends Companies_LayoutController {
  ...
  contentHTML() {
    ...
    const fields = `
      <div class="space-y-6">
        <h2 class="text-xl font-bold text-slate-900 dark:text-white">New Page</h2>

        <div class="grid grid-cols-2 gap-4">
          <div class="col-span-2 space-y-1">
            <label class="text-[10px] font-bold text-slate-400 dark:text-slate-300 uppercase tracking-wider">Page Name</label>
            <input type="text" name="page[name]" required placeholder="e.g. Cashier Dashboard"
          ...
          <div class="space-y-1">
            <label class="text-[10px] font-bold text-slate-400 dark:text-slate-300 uppercase tracking-wider">Target Role</label>
          ...
          <div class="space-y-1">
            <label class="text-[10px] font-bold text-slate-400 dark:text-slate-300 uppercase tracking-wider">Target Resolution</label>
          ...
          <div class="col-span-2 space-y-1">
            ...
            <textarea name="page[description]" rows="2" placeholder="Optional description"
          ...
          <div class="col-span-2 space-y-1">
            <label class="text-[10px] font-bold text-slate-400 dark:text-slate-300 uppercase tracking-wider">Layout Manifest (JSON)</label>
