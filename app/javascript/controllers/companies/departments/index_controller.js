...
export default class Companies_Departments_IndexController extends Companies_LayoutController {
  // Departments dashboard — table hydrates from the index JSON of the current URL.
  // Search/filter controls render from the active TableConfig via the shared helpers
  // (dynamicSearchHTML / dynamicFiltersHTML).
  // Depends on BE: Companies::DepartmentsController#index (list + Meilisearch q / filters[key])
  ...
  contentHTML() {
    ...
    const fallbackColumns = [
      { key: "name", name: translate("Department Name") },
