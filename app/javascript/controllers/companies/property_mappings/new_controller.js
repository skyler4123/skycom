...
export default class Companies_PropertyMappings_NewController extends Companies_LayoutController {
  connect() {
    super.connect()
  ...
  contentHTML() {
    ...
    const fields = `
      <div class="space-y-6">
        <h2 class="text-xl font-bold text-slate-900 dark:text-white">${translate("New Property Mapping")}</h2>
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="col-span-2 space-y-1">
            ...
            <input type="text" name="property_mapping[name]" required
              placeholder="e.g. Cosmetics Mapping"
          ...
          <div class="space-y-1">
            ...
            <select name="property_mapping[category_id]"
          ...
          <div class="space-y-1">
            ...
            <select name="property_mapping[resource_name]"
              class="w-full px-3 py-2 border border-slate-200 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-sm text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none">
              ${resourceOptions}
            </select>
          </div>
          ...
          <div class="col-span-2 space-y-1">
            ...
            <textarea name="property_mapping[description]" rows="3"
        ...
        <div class="flex justify-end pt-6 border-t border-slate-200 dark:border-slate-700">
          <button type="submit"
            ...
            ${translate("Save Property Mapping")}
          </button>
        </div>
      </div>
    `
    ...
    return `
      <div class="p-4 overflow-y-auto">
        ${form({
          action: Helpers.create_company_property_mappings_path(currentCompany().id),
          method: "POST",
