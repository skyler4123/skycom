...
export default class Education_Courses_IndexController extends Education_LayoutController {
      ...
      <div class="p-8 overflow-y-auto">
        <div class="flex flex-wrap justify-between items-center gap-4 mb-8">
          <div class="flex flex-col gap-1">
            <h1 class="text-gray-900 dark:text-white text-3xl font-bold leading-tight tracking-tight">Course Management
            </h1>
            <p class="text-gray-500 dark:text-gray-400 text-base font-normal leading-normal">Manage all the courses in
              the school.</p>
          </div>
          <button
            class="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-blue-600 text-white text-sm font-medium leading-normal hover:bg-blue-700">
            <span class="material-symbols-outlined font-normal">add</span>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
            ...
            <table class="w-full text-left">
              <thead>
                <tr
                  ...
                  <th class="py-3 px-4 font-medium">COURSE CODE</th>
                  <th class="py-3 px-4 font-medium">INSTRUCTOR</th>
              ...
              <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                <tr class="text-sm">
                  <td class="py-3 px-4 font-medium text-gray-900 dark:text-white">Introduction to Computer Science</td>
                  <td class="py-3 px-4">CS101</td>
                  <td class="py-3 px-4">Dr. Alan Turing</td>
                  <td class="py-3 px-4">120</td>
                  <td class="py-3 px-4">
                    <div class="flex justify-end gap-2">
                      <button
                        class="flex items-center justify-center p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400">
                        <span class="material-symbols-outlined text-base font-normal">edit</span>
                      </button>
                      <button
                        class="flex items-center justify-center p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400">
                        <span class="material-symbols-outlined text-base font-normal">delete</span>
                      </button>
                    </div>
                  </td>
                </tr>
                <tr class="text-sm">
                  <td class="py-3 px-4 font-medium text-gray-900 dark:text-white">Mathematics 101</td>
                  <td class="py-3 px-4">MATH101</td>
                  <td class="py-3 px-4">Dr. Ada Lovelace</td>
                ...
                <tr class="text-sm">
                  <td class="py-3 px-4 font-medium text-gray-900 dark:text-white">History of Art</td>
                  <td class="py-3 px-4">ART205</td>
                  <td class="py-3 px-4">Prof. Vincent Van Gogh</td>
                ...
                <tr class="text-sm">
                  <td class="py-3 px-4 font-medium text-gray-900 dark:text-white">Physics II</td>
                  <td class="py-3 px-4">PHY202</td>
                  <td class="py-3 px-4">Dr. Marie Curie</td>
                ...
                <tr class="text-sm">
                  <td class="py-3 px-4 font-medium text-gray-900 dark:text-white">World Literature</td>
                  <td class="py-3 px-4">LIT301</td>
                  <td class="py-3 px-4">Prof. Jane Austen</td>
                ...
                <tr class="text-sm">
                  <td class="py-3 px-4 font-medium text-gray-900 dark:text-white">Chemistry Fundamentals</td>
                  <td class="py-3 px-4">CHEM100</td>
                  <td class="py-3 px-4">Dr. Rosalind Franklin</td>
                ...
                <tr class="text-sm">
                  <td class="py-3 px-4 font-medium text-gray-900 dark:text-white">Introduction to Psychology</td>
                  <td class="py-3 px-4">PSY101</td>
                  <td class="py-3 px-4">Dr. Sigmund Freud</td>
          ...
          <div class="flex justify-between items-center p-4 border-t border-gray-200 dark:border-gray-700">
            <span class="text-sm text-gray-600 dark:text-gray-300">Showing 1 to 7 of 56 courses</span>
            <div class="flex gap-2">
              <button
                class="flex items-center justify-center px-3 py-1.5 border border-gray-300 dark:border-gray-700 rounded-md text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-50"
                disabled="">Previous</button>
              <button
                class="flex items-center justify-center px-3 py-1.5 border border-gray-300 dark:border-gray-700 rounded-md text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-800">Next</button>
            </div>
          </div>
        </div>
      </div>
