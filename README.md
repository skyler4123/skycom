...
##
  ...
  bundle exec rails g scaffold Product company_group:references company:references brand:references education_type:integer hospital_type:integer hotel_type:integer restaurant_type:integer retail_type:integer name description code price:decimal sku:string:index barcode:string:index upc:string:index ean:string:index manufacturer_code:string serial_number:string:index batch_number:string expiration_date:datetime status:integer business_type:integer discarded_at:datetime:index --force
