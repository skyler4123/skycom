...
##
  ...
  bundle exec rails g scaffold OrderItemAppointment order:references appoint_from:references{polymorphic} appoint_to:references{polymorphic} appoint_for:references{polymorphic} appoint_by:references{polymorphic} unit_price:decimal quantity:integer total_price:decimal name description code status:integer business_type:integer discarded_at:datetime:index --force
  ...
  bundle exec rails g scaffold PurchaseItem purchase:references name description code status:integer business_type:integer discarded_at:datetime:index --force
  ...
  bundle exec rails g scaffold InventoryItem name
