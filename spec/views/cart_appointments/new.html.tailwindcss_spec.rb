...
RSpec.describe "cart_appointments/new", type: :view do
  before(:each) do
    assign(:cart_appointment, CartAppointment.new(
      cart: nil,
      appoint_from: nil,
      appoint_to: nil,
      appoint_for: nil,
  ...
  it "renders new cart_appointment form" do
    render

    assert_select "form[action=?][method=?]", cart_appointments_path, "post" do
