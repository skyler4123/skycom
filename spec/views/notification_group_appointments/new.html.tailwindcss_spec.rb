...
RSpec.describe "notification_group_appointments/new", type: :view do
  before(:each) do
    assign(:notification_group_appointment, NotificationGroupAppointment.new(
  ...
  it "renders new notification_group_appointment form" do
    render

    assert_select "form[action=?][method=?]", notification_group_appointments_path, "post" do
