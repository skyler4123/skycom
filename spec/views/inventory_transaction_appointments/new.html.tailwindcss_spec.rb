...
RSpec.describe "inventory_transaction_appointments/new", type: :view do
  before(:each) do
    assign(:inventory_transaction_appointment, InventoryTransactionAppointment.new(
  ...
  it "renders new inventory_transaction_appointment form" do
    render
