...
RSpec.describe "product_appointments/new", type: :view do
  before(:each) do
    assign(:product_appointment, ProductAppointment.new(
      product: nil,
      appoint_from: nil,
      appoint_to: nil,
      appoint_for: nil,
  ...
  it "renders new product_appointment form" do
    render

    assert_select "form[action=?][method=?]", product_appointments_path, "post" do
