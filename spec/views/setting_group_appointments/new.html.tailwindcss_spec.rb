...
RSpec.describe "setting_group_appointments/new", type: :view do
  before(:each) do
    assign(:setting_group_appointment, SettingGroupAppointment.new(
      setting_group: nil,
      appoint_from: nil,
      appoint_to: nil,
      appoint_for: nil,
  ...
  it "renders new setting_group_appointment form" do
    render

    assert_select "form[action=?][method=?]", setting_group_appointments_path, "post" do
