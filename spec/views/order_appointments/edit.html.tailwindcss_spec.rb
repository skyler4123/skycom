...
RSpec.describe "order_appointments/edit", type: :view do
  let(:order_appointment) {
  ...
  before(:each) do
    assign(:order_appointment, order_appointment)
  end

  it "renders the edit order_appointment form" do
    render

    assert_select "form[action=?][method=?]", order_appointment_path(order_appointment), "post" do
