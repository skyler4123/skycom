...
RSpec.describe "inventory_item_appointments/new", type: :view do
  before(:each) do
    assign(:inventory_item_appointment, InventoryItemAppointment.new(
      inventory_item: nil,
      appoint_from: nil,
      appoint_to: nil,
      appoint_for: nil,
  ...
  it "renders new inventory_item_appointment form" do
    render

    assert_select "form[action=?][method=?]", inventory_item_appointments_path, "post" do
