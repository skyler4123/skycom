...
RSpec.describe "article_appointments/edit", type: :view do
  let(:article_appointment) {
  ...
  before(:each) do
    assign(:article_appointment, article_appointment)
  end

  it "renders the edit article_appointment form" do
    render

    assert_select "form[action=?][method=?]", article_appointment_path(article_appointment), "post" do
