...
RSpec.describe "inventory_transactions/edit", type: :view do
  ...
  before(:each) do
    assign(:inventory_transaction, inventory_transaction)
  end

  it "renders the edit inventory_transaction form" do
    render

    assert_select "form[action=?][method=?]", inventory_transaction_path(inventory_transaction), "post" do
