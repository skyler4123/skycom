...
RSpec.describe "order_group_appointments/new", type: :view do
  before(:each) do
    assign(:order_group_appointment, OrderGroupAppointment.new(
      order_group: nil,
      appoint_from: nil,
      appoint_to: nil,
      appoint_for: nil,
  ...
  it "renders new order_group_appointment form" do
    render

    assert_select "form[action=?][method=?]", order_group_appointments_path, "post" do
