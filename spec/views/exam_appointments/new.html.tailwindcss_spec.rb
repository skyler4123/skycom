...
RSpec.describe "exam_appointments/new", type: :view do
  before(:each) do
    assign(:exam_appointment, ExamAppointment.new(
      exam: nil,
      appoint_from: nil,
      appoint_to: nil,
      appoint_for: nil,
  ...
  it "renders new exam_appointment form" do
    render

    assert_select "form[action=?][method=?]", exam_appointments_path, "post" do
