...
RSpec.describe "document_group_appointments/edit", type: :view do
  let(:document_group_appointment) {
  ...
  before(:each) do
    assign(:document_group_appointment, document_group_appointment)
  end

  it "renders the edit document_group_appointment form" do
    render

    assert_select "form[action=?][method=?]", document_group_appointment_path(document_group_appointment), "post" do
