...
RSpec.describe "service_appointments/new", type: :view do
  before(:each) do
    assign(:service_appointment, ServiceAppointment.new(
      service: nil,
      appoint_from: nil,
      appoint_to: nil,
      appoint_for: nil,
  ...
  it "renders new service_appointment form" do
    render

    assert_select "form[action=?][method=?]", service_appointments_path, "post" do
