...
RSpec.feature "Admin::PaymentMethods", type: :feature, js: true do
  ...
  let!(:pm1) { create(:payment_method, name: "Visa Card", code: "VISA", business_type: :b2c, country: 840) }
  let!(:pm2) { create(:payment_method, name: "Wire Transfer", code: "WIRE", business_type: :b2b, country: 840) }
  let!(:pm3) { create(:payment_method, name: "MoMo Wallet", code: "MOMO", business_type: :b2c, country: 704) }
