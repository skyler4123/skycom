...
RSpec.describe ServiceAppointmentsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #new" do
      expect(get: "/service_appointments/new").to route_to("service_appointments#new")
    end
    ...
    it "routes to #edit" do
      expect(get: "/service_appointments/1/edit").to route_to("service_appointments#edit", id: "1")
    end
